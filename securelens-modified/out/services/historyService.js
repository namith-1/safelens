...
class HistoryService {
     ...
     */
    async recordScan(result, targetPath) {
    ...
    generateSummaryText(result, targetPath, workspaceRoot) {
    ...
    buildTree(findings, workspaceRoot) {
    ...
    async saveHistoryFiles(result, targetPath, workspaceRoot) {
    ...
    async updateFileHistory(filePath, findings, workspaceRoot, historyDir) {
...
HistoryService.outputChannel = null;
